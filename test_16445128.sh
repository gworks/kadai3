...
./16445128.sh a 1 2> $tmp-out && ERROR_EXIT "TEST2-1"
...
./16445128.sh 1 b 2> $tmp-out && ERROR_EXIT "TEST3-1"
...
./16445128.sh 0 2 2> $tmp-out && ERROR_EXIT "TEST4-1"
...
./16445128.sh 2 0 2> $tmp-out && ERROR_EXIT "TEST5-1"
